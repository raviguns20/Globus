package com.globus.material.api;

import java.lang.ref.WeakReference;
import java.util.ArrayList;

import com.globus.ActivityHome;
import com.globus.material.util.ViewUtil;
...
public class ToolbarManager {
    ...
    public ToolbarManager(AppCompatActivity mainActivity, Toolbar toolbar, int defaultGroupId, int rippleStyle, int animIn, int animOut){
        this(mainActivity, toolbar, defaultGroupId, rippleStyle, new SimpleAnimator(animIn, animOut));
    }

    public ToolbarManager(AppCompatActivity mainActivity, Toolbar toolbar, int defaultGroupId, int rippleStyle, Animator animator){
    ...
    public static class BaseNavigationManager extends NavigationManager{
         ...
         */
        public BaseNavigationManager(int styledId, AppCompatActivity mainActivity, Toolbar toolbar, DrawerLayout drawerLayout){
