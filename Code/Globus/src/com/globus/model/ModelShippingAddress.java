...
public class ModelShippingAddress {
	...
	private int UserDefaultShipping; 

	public ModelShippingAddress(int AddressBookId,String FirstName, String LastName,String Company,String City,
	...
	public ModelShippingAddress(String UserId,String UserFirstname, String UserLastname,String UserCompany,
			String UserCity,String UserCountry,String Suffix,int UserPostalcode,String UserTelephone,String UserFax,String UserRegion,
			String UserStreet1,String UserStreet2,int UserDefaultShipping,String UserMiddlename) {
		...
		this.UserDefaultShipping=UserDefaultShipping;
	...
	public ModelShippingAddress(int AddressBookId,String FirstName, String LastName,String Company,String City,
			String Suffix,int Postcode,String Telephone,String Fax,String Street,int RegionId,
			int Gender,String Mobile,String Street1,String Street2,String CountryId,String CountryName,int ZoneId,String ZoneName,String AddressType) {
...
//			this.State = "";
	...
	public int getUserDefaultShipping() {
		return UserDefaultShipping;
	}

	public void setUserDefaultShipping(int UserDefaultShipping) {
		this.UserDefaultShipping = UserDefaultShipping;
